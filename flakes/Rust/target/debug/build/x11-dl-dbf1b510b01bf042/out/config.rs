...
pub const gl: Option<&'static str> = Some("/nix/store/rarvfpm927fcbd6b9p0crg09w9r3ywb3-libglvnd-1.7.0/lib");
...
pub const x11: Option<&'static str> = Some("/nix/store/3vlnkr6z7hh86rrn087df45s4cfjxy65-libx11-1.8.13/lib");
pub const xlib_xcb: Option<&'static str> = Some("/nix/store/3vlnkr6z7hh86rrn087df45s4cfjxy65-libx11-1.8.13/lib");
