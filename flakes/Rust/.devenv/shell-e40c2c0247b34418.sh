...
out='/nix/store/mk30003yq6pzlkn55cqcwbz7xbc3cg0v-devenv-shell-env'
export out
...
strictDeps=''
export strictDeps
DEVENV_PROFILE='/nix/store/f0926c0jszfcwl5h4j46x359p5jmbfg6-devenv-profile'
export DEVENV_PROFILE
prefix='/nix/store/mk30003yq6pzlkn55cqcwbz7xbc3cg0v-devenv-shell-env'
LD_FOR_BUILD='ld'
export LD_FOR_BUILD
LD='ld'
export LD
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/3qgy8q2j64v2m9jy3a5jmssacbblhd4r-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/f0926c0jszfcwl5h4j46x359p5jmbfg6-devenv-profile" ]
then
  ln -snf /nix/store/f0926c0jszfcwl5h4j46x359p5jmbfg6-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
exec /tmp/devenv-envpHerUl/script 