...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/3qgy8q2j64v2m9jy3a5jmssacbblhd4r-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/wzncbrg5z3yryj8q1xcm3kmk46206n6b-devenv-profile" ]
then
  ln -snf /nix/store/wzncbrg5z3yryj8q1xcm3kmk46206n6b-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
export CONFIG_SHELL
out='/nix/store/0mhsfhjgqqxrnqbbdsvxk1645v8sfcfx-devenv-shell-env'
export out
DEVENV_RUNTIME='/run/user/1000/devenv-0b49da7'
export DEVENV_RUNTIME
PS4='+ '
prefix='/nix/store/0mhsfhjgqqxrnqbbdsvxk1645v8sfcfx-devenv-shell-env'
AS='as'
export AS
NM_FOR_BUILD='nm'
export NM_FOR_BUILD
...
LD_LIBRARY_PATH='/nix/store/vjcwhp0milwa1jqy1inpjxrsh8hjrgwc-wayland-1.26.0/lib:/nix/store/2nlq43n0gc4s8cbjjxpnfg97kgmk8blh-wayland-protocols-1.49/lib:/nix/store/yk95z4hjlzdk418px0fc797qszccfj5p-libxkbcommon-1.13.2/lib:/nix/store/y11wm3zhcvjav2vbav9p0ky99xa2wlyv-libinput-1.31.3/lib:/nix/store/4hlgp6r4j5p6b2b9sxw01cba0x3fjxd6-systemd-minimal-libs-261.2/lib:/nix/store/yn8y98bfwgr9jxcrl1x32h04mshpn9wc-dbus-1.16.2-lib/lib:/nix/store/8kmh5aaiadz1vfv1nal7vf3x41b2l92j-pixman-0.46.4/lib:/nix/store/v5c40hysv678q0yjwvdi0q97rdmxr9r4-mesa-26.2.1/lib:/nix/store/5qg70j0rzbxqlxlzrq87k4ksgzdwrwr6-libdrm-2.4.134/lib:/nix/store/rcwvn48vi65zr4jzgk0rp3y7czfd1a9m-seatd-0.9.3/lib:/nix/store/iv0yvsywa1v35xzdkqz9wdzhg7vshpdd-fontconfig-2.18.2-lib/lib:/nix/store/lk4614327cn1h9z3m6cvnls95n13m1cj-vulkan-loader-1.4.357.0/lib:/nix/store/rarvfpm927fcbd6b9p0crg09w9r3ywb3-libglvnd-1.7.0/lib:/nix/store/6slvk1x4gashcfg4bgvcc7ywbwzf1isy-egl-wayland-1.1.21/lib'
...
DEVENV_PROFILE='/nix/store/wzncbrg5z3yryj8q1xcm3kmk46206n6b-devenv-profile'
...
exec /tmp/devenv-env5wWFTa/script 