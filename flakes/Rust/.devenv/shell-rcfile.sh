...
source "/home/ty/NixOS/Master/flakes/Rust/.devenv/shell-env.sh"
...
exec "/run/current-system/sw/bin/fish" -i -C "source /home/ty/NixOS/Master/flakes/Rust/.devenv/devenv.fish"
